...
def assemble_grid(
    ...
    fig.text(
        0.55,
        0.925,
        "Prompting Strategies",  # "Baseline vs Chain-of-Thought"
        ha="center",
        va="top",
        fontsize=18,
    )
    ...
    plt.close(fig)
    print(f"mega-grid saved to: {out_png}")


if __name__ == "__main__":

    for prompt in PROMPTS:
        pkl = f"new_results_paper_rev/time/{prompt}/rev_21x21x5_new_all/data_log.pkl"  #  new_results_temp1/time/rev_21x21x5_new_all/data_log.pkl
        out_dir = f"new_figures_paper_rev/"
    ...
    assemble_grid(base_dir=out_dir, out_png="new_figures_paper_rev/time/combined")
    # assemble_grid()
